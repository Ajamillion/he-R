...
export const isValidDateInput = (value: unknown): value is string => {
  ...
  return !Number.isNaN(date.getTime()) && toInputValue(date) === value;
};
...
export const differenceInDays = (from: string, to: string) => {
