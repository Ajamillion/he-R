...
| Phase 1 · Guided Companion | Daily logging, insights, and JSON export exist, but CSV/PDF outputs, sharing, analytics, and native packaging are outstanding. | 28% | MVP now tracks insights; next deliverables are export/share UX, instrumentation, and Capacitor shells. |
...
4. Define CSV/PDF export schema informed by the JSON snapshot for clinician workflows.
